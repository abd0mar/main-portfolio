...
export class Projects {
    ...
    this.projectsList = [
      {
        ...
        imageOne: '../public/images/project-dashboard-dark.webp',
        liveDemoLink: 'https://abd0mar.github.io/Dashboard_Project/',
        githubLink: 'https://github.com/abd0mar/Dashboard_Project.git',
      },
      {
        name: 'TODO List',
        description: 'A clean Todo List app built with Vanilla JavaScript featuring task management, filters, and local storage.',
        technologies: ['HTML', 'CSS', 'Vanilla JS'],
        imageOne: '../public/images/todo-list.webp',
        liveDemoLink: 'https://abd0mar.github.io/Todo_List_App/',
  ...
  renderProjects() {
    ...
    this.projectsList.forEach((project: { name: string; description: string; technologies: string[]; imageOne: string; liveDemoLink: string; githubLink: string }, index: number) => {
      const projectBox: HTMLDivElement = document.createElement("div");
      projectBox.className = 'project-card group';
      projectBox.innerHTML = `
        <div class="absolute flex items-center justify-center rounded-lg top-3 left-3 px-3 py-1 border border-border z-10 bg-bg-primary/90 backdrop-blur-2xl duration-(--duration)">
          <span class="font-bold text-text text-mdduration-(--duration)">${this.projectsList.length < 10 ? "0" + (index + 1) : (index + 1)}</span>
        </div>
        ...
        <div class="project-card-info">
          ...
          <div class="project-contact">
            <a href="${project.liveDemoLink}"  target="_blank" class="preview duration-(--duration)" aria-label="View live demo">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-external-link w-4 h-4" aria-hidden="true"><path d="M15 3h6v6"></path><path d="M10 14 21 3"></path><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path></svg>
              Live Demo
            </a>
            <a href="${project.githubLink}" target="_blank" class="github-btn duration-(--duration)">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" aria-label="View this project on GitHub" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github w-4 h-4" aria-hidden="true"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
            </a>
          </div>
        </div>`;
